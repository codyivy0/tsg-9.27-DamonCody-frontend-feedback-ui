        ...
        return (
            <div className="w-full max-w-2xl mx-auto">
                <div className="bg-slate-800 border border-slate-600 rounded-lg p-6">
                    ...
                    <p className="text-gray-400 mb-4">The review you're looking for doesn't exist.</p>
                    <button
                        onClick={() => navigate('/reviews')}
                ...
                <div className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-2xl font-bold text-white">{review.providerName}</p>
                        </div>
                    </div>
                    ...
                    {review.timestamp && (
                        <div className="mb-8">
                            ...
                            <p className="text-lg text-gray-300">{formatDate(review.timestamp)}</p>
                        </div>
                    )}
                </div>
